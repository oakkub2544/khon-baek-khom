...
งานนี้ยังไม่เปิดสาธารณะ มีหน้า lock กั้นอยู่ — ขอรหัสจากเจ้าของงาน

ตัวรหัสไม่ได้อยู่ในรีโปนี้ ถ้าจะเปลี่ยนรหัส:

```bash
python3 tools/set-gate-key.py
```

มันจะถามรหัสใหม่แบบไม่แสดงบนจอ แล้วเขียนเฉพาะค่าที่ derive แล้วลงไฟล์ ตัวรหัสไม่ถูกบันทึกที่ไหนเลย
รายละเอียดว่ากั้นด้วยอะไรและกั้นได้แค่ไหน อ่านคอมเมนต์เหนือ `const GATE` ใน `คนแบกโคม.dc.html`
